...
public class Smooth {
    public void linearSmooth3(double in[], double out[], int N) {
        int i;
        if (N < 3) {
            for (i = 0; i <= N - 1; i++) {
                out[i] = in[i];
    ...
    public void linearSmooth5(double in[], double out[], int N) {
        int i;
        if (N < 5) {
            for (i = 0; i <= N - 1; i++) {
                out[i] = in[i];
    ...
    public void linearSmooth7(double in[], double out[], int N) {
        int i;
        if (N < 7) {
            for (i = 0; i <= N - 1; i++) {
                out[i] = in[i];
